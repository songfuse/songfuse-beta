...
const PlaylistEditor = ({ 
  ...
  const [isPublic, setIsPublic] = useState(true); // Default to public visibility
  ...
  return (
    <>
      <div className="flex flex-col h-full">
        ...
        <div className="border-t dark:border-gray-800 border-gray-300 dark:bg-[#191414]/80 bg-white/80 sticky bottom-0 left-0 right-0 z-10 mt-8 w-full">
